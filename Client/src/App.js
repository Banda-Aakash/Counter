...
const MyCounter=()=>{
  ...
  const MyfetchCounter=useCallback(async ()=>{
    try{
      const response=await axios.get('https://counter-p0ew.onrender.com/api/myCounter');
  ...
  const incrementCounter = useCallback(async () => {
    try {
      await axios.post('https://counter-p0ew.onrender.com/api/mycounter/increment');
  ...
  const decrementCounter = useCallback(async () => {
    try {
      await axios.post('https://counter-p0ew.onrender.com/api/mycounter/decrement');
...
const Counter = () => {
  ...
  const fetchCounter = useCallback(async () => {
    try {
      const response = await axios.get('https://counter-p0ew.onrender.com/api/counter');
  ...
  const incrementCounter = useCallback(async () => {
    try {
      await axios.post('https://counter-p0ew.onrender.com/api/counter/increment');
  ...
  const decrementCounter = useCallback(async () => {
    try {
      await axios.post('https://counter-p0ew.onrender.com/api/counter/decrement');
